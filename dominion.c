...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
		return Adventure(drawtreasure, state, currentPlayer, z, temphand);
			
    case council_room:
		return Council_Room(state, currentPlayer, handPos);
			
    case feast:
		return Feast(state, currentPlayer, temphand, choice1);
		
    case gardens:
      return -1;
			
    case mine:
		return Mine(state, choice1, choice2, currentPlayer, handPos);
...
/*Functions That Contain Code from cardEffect, Seperated into functions 
*/
Adventure(int drawtreasure, struct gameState *state, int currentPlayer, int z, int *temphand ){
/* To Find what I need for the parameters of this function, look for uninitialized variables.
 * 1. drawtreasure, taken from treasureCard
 * 2. State
 * 3. Current player
 * 4. z
 * 5. Temphand
...
Feast(struct gameState *state, int currentPlayer, int *temphand, int choice1){
...
int Mine(struct gameState *state, int choice1, int choice2, int currentPlayer, int handPos){	 
/* variables we will need to pass into the parameters
 * gameState *state
 * choice1
 * choice2
 * currentPlayer
...
/* variables we will need in the parameters
 * currentPlayer
 * state
 * handPos
 */ 
