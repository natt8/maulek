	  ...
	  for (i = 0; i < MAX_TESTS; i++) {
	   ...
	   //Initiate valid state variables
		  ...
		  if (seed % 3 == 0) {
		   ...
		   cardEffect(adventurer, 1, 1, 1, &state, 3, bonus);		//Run adventurer card
	  }
	   ...
	   for (i = 0; i < MAX_TESTS; i++) {
		...
		cardEffect(adventurer, 1, 1, 1, &stat, 3, bonus);		//Run adventurer card
 	   }
	   ...
	   for (i = 0; i < MAX_TESTS; i++) {
		 ...
		 cardEffect(adventurer, 1, 1, 1, &sta, 3, bonus);		//Run adventurer card
	   }
